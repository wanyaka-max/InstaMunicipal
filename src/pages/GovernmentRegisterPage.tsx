...
import GovernmentRegisterForm from "@/components/auth/GovernmentRegisterForm";
import { Shield } from "lucide-react";

const GovernmentRegisterPage = () => {
  return (
    <div
    ...
    >
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <GovernmentRegisterForm />
      </div>
    </div>
  );
};

export default GovernmentRegisterPage;
